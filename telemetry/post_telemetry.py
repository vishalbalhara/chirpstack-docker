...
thingsboard_host = "localhost:9090"
...
while True:
    ...
    url = f"http://{thingsboard_host}/api/v1/{t1_access_token}/telemetry"
    ...
    url = f"http://{thingsboard_host}/api/v1/{th1_access_token}/telemetry"
